...
LABELS = ['Glass',' '] # Others, Siren, Honks
...
def get_microphone_level():
    ...
    while True:
        ...
        if len(levels_2) >= int(RATE*2/CHUNK):

            temp_levels.extend(levels_2)
 
            four_sec = temp_levels

            temp_levels = levels_2
...
class Logic(BoxLayout):
    ...
    def start(self):
        ...
        Clock.schedule_interval(self._listen, 2)
    ...
    def _listen(self,dt):
        ...
        input_length = 176400 # Sampling rate * Audio duration = 44100 * 4 = 176400 
        ...
        data, _ = librosa.core.load('output.wav', sr=44100, res_type="kaiser_fast")
		# preprocessing
        ...
        print(y)
		# convert to melspec
        melspec = librosa.feature.melspectrogram(y = y, sr = 44100, n_fft=2048, hop_length=1024, n_mels=120)
...
if __name__ == "__main__":
    ...
    # Loading stuff
    model = load_model('models/best_ais_8k_new.h5')
    model.load_weights('models/best_ais_8k_new.h5')
